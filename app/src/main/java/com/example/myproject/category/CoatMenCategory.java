...
public class CoatMenCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_coat_men_category);
        ...
        title = findViewById(R.id.titleCategory2);
        title.setText("COAT");
        ...
        gridView = findViewById(R.id.coat_men);
                    ...
                    public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                        ...
                        for (DocumentChange dc : value.getDocumentChanges()) {
                            ...
                            if (dc.getType() == DocumentChange.Type.ADDED) {
                                ...
                                if (product.getCategoryCode().equals("m_coat")) {

...
public class TshirtMenCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tshirt_men_category);
        progressDialog = new ProgressDialog(this);
        progressDialog.setCancelable(false);
        progressDialog.setMessage("Fetching data...");
        progressDialog.show();

        title = findViewById(R.id.titleCategory11);
        title.setText("TSHIRT");

        btnDone = findViewById(R.id.btnDone11);
        ...
        gridView = findViewById(R.id.tshirt_men);
                    ...
                    public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                        ...
                        for (DocumentChange dc : value.getDocumentChanges()) {
                            ...
                            if (dc.getType() == DocumentChange.Type.ADDED) {
                                ...
                                if (product.getCategoryCode().equals("m_tshirt")) {

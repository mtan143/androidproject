...
public class PantsMenCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pants_men_category);
        progressDialog = new ProgressDialog(this);
        progressDialog.setCancelable(false);
        progressDialog.setMessage("Fetching data...");
        progressDialog.show();

        title = findViewById(R.id.titleCategory5);
        title.setText("PANTS");

        btnDone = findViewById(R.id.btnDone5);
        ...
        gridView = findViewById(R.id.pants_men);
                    ...
                    public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                        ...
                        for (DocumentChange dc : value.getDocumentChanges()) {
                            ...
                            if (dc.getType() == DocumentChange.Type.ADDED) {
                                ...
                                if (product.getCategoryCode().equals("m_pants")) {
